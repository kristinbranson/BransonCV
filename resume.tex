...
\geometry{left=2cm, top=1cm, right=1.4cm, bottom=2cm, footskip=.5cm}
...
\bluesky{bsky.social}{kristinmbranson}
% \skype{skype-id}
% \reddit{reddit-id}
...
\entrytitlestyle{University of California, San Diego} & \entrylocationstyle{La Jolla, CA} \\
\entrypositionstyle{Ph.D., M.S., Computer Science} & \entrydatestyle{2007,2002} \\
~~\descriptionstyle{Dissertation Title: {\em Tracking Multiple Mice through Severe Occlusions}}\\
~~\descriptionstyle{Advisers: Serge Belongie and Sanjoy Dasgupta}\\
\entrytitlestyle{Harvard University} & \entrylocationstyle{Cambridge, MA} \\
\entrypositionstyle{A.B. {\em Cum Laude}, Computer Science} & \entrydatestyle{2000}
\end{tabular*}
}
...
\setlength{\extrarowheight}{0pt}
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} L{\textwidth - 4.5cm} R{4.5cm}}
\entrytitlestyle{HHMI Janelia Research Campus} & \entrylocationstyle{Ashburn, VA}\\
\entrypositionstyle{Senior Group Leader} & \entrydatestyle{2017-present} \\
\entrypositionstyle{Head of Computation \& Theory} & \entrydatestyle{2017-2022} \\
\entrypositionstyle{Group Leader} & \entrydatestyle{2010-2017}
\end{tabular*}}

{\setlength\tabcolsep{0pt}
\setlength{\extrarowheight}{0pt}
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} L{\textwidth - 4.5cm} R{4.5cm}}
\entrytitlestyle{California Institute of Technology} & \entrylocationstyle{Pasadena, CA}\\
\entrypositionstyle{Postdoctoral Researcher} & \entrydatestyle{2007-2009}\\
~~\descriptionstyle{Advisers: Pietro Perona and Michael Dickinson}
\end{tabular*}}

{\setlength\tabcolsep{0pt}
\setlength{\extrarowheight}{0pt}
\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} L{\textwidth - 4.5cm} R{4.5cm}}
\entrytitlestyle{NASA Intern} & \\
\entrypositionstyle{Graduate Student Researcher} & \entrylocationstyle{NASA Ames RC}\\
~~\descriptionstyle{Research Institute for Advanced Computer Science} & \entrydatestyle{Summer 2000 \& 2001}\\
\entrypositionstyle{Undergraduate Researcher} & \entrylocationstyle{NASA Armstrong Flight RC}\\
~~\descriptionstyle{NASA Academy Program} & \entrydatestyle{Summer 1999}
\end{tabular*}}
...
\hline
  ...
  Rutuja Patil & 2017-2024 & & Software Engineer in Edge Computing\\
  Ivan (Felip\'e) Rodriguez & 2017-2018 & MS, CS, U.~Puerto Rico, 2019 & PhD student, Cognitive Science, Brown \\
  Lingqi Zhang & 2023-present & & Theory Fellow with my lab \\
  Aniket Ravan & 2024-present & & Machine Learning Researcher in my lab \\
  Eyrun Eyjolfsdottir & 2024-present & & Machine learning consultant \\
  Kai Horstmann & 2025-present & & PhD student, CS, Cornell\\
  Yijia Dai & 2025-present & & PhD student, CS, Cornell\\
  \hline
\end{tabular}
\end{center}
\endgroup
